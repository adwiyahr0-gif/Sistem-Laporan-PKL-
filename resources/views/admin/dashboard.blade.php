    ...
    <div class="space-y-8">
        <div class="bg-white rounded-3xl p-8 shadow-sm border border-indigo-50/50 relative overflow-hidden">
            <div class="relative z-10">
                ...
                <p class="text-slate-500 text-sm mt-1">Selamat datang kembali di panel monitoring, <span class="text-indigo-600 font-bold">Admin Kominfo</span>.</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-all group">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-3xl font-black text-slate-800 mt-2">24</h3>
                    </div>
                ...
                <div class="mt-4 flex items-center text-xs font-bold text-green-500 bg-green-50 w-fit px-2 py-1 rounded-lg">
                    <i class="fa-solid fa-arrow-up mr-1"></i> +2 Minggu ini
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-all group">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-3xl font-black text-slate-800 mt-2">156</h3>
                    </div>
                ...
                <div class="mt-4 flex items-center text-xs font-bold text-indigo-500 bg-indigo-50 w-fit px-2 py-1 rounded-lg">
                    <i class="fa-solid fa-clock mr-1"></i> 12 Perlu Validasi
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-all group">
                <div class="flex justify-between items-start">
                    <div>
                        <p class="text-xs font-black text-slate-400 uppercase tracking-widest">Hadir Hari Ini</p>
                        <h3 class="text-3xl font-black text-slate-800 mt-2">22</h3>
                    </div>
                ...
                <div class="mt-4 flex items-center text-xs font-bold text-emerald-600">
                    <span class="w-2 h-2 bg-emerald-500 rounded-full mr-2 animate-pulse"></span> 92% Kehadiran
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-all group">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-3xl font-black text-slate-800 mt-2">5</h3>
                    </div>
        ...
        <div class="bg-white rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden">
            <div class="p-8 border-b border-slate-50 flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <a href="#" class="px-6 py-3 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl text-xs font-bold transition-all w-fit">
                    Lihat Semua Laporan
                </a>
            </div>
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            <td class="px-8 py-5">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-xl bg-indigo-100 text-indigo-600 flex items-center justify-center font-bold">R</div>
                                    <div>
                                        <p class="text-sm font-bold text-slate-800">Rabiatul Adwiyah</p>
                                        <p class="text-[10px] text-slate-400 font-bold">Universitas Sumatera Utara</p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-8 py-5">
                                <p class="text-sm text-slate-600 leading-relaxed max-w-xs truncate">Mempelajari framework Laravel dan integrasi database Tailwind...</p>
                            </td>
                            <td class="px-8 py-5 text-center">
                                <span class="px-3 py-1 bg-amber-50 text-amber-600 text-[10px] font-black rounded-lg uppercase">Pending</span>
                            </td>
                            <td class="px-8 py-5 text-right">
                                <button class="p-2 text-indigo-500 hover:bg-indigo-50 rounded-lg transition-all" title="Lihat Detail"><i class="fa-solid fa-eye"></i></button>
                                <button class="p-2 text-emerald-500 hover:bg-emerald-50 rounded-lg transition-all ml-2" title="Validasi"><i class="fa-solid fa-check"></i></button>
                            </td>
                        </tr>
                    </tbody>
                </table>
